...
hook.remove("PostResetGame", "jpxsUploader")
hook.add("PostResetGame", "jpxsUploader", function()
    if not plugin.isEnabled then return end
    init()
end)
...
hook.remove("PostPlayerCreate", "jpxsUploader")
hook.add("PostPlayerCreate", "jpxsUploader", function (ply)
