...
export class Avatar {
  ...
  public static getAvatarUrl(avatar: Avatar, options: {
    embed?: boolean;
    rotate?: boolean;
    ...
    const url = new URL("https://beta.jpxs.io/avatar");
  ...
  public url(options: Parameters<typeof Avatar.getAvatarUrl>[1] = {}): string {
    return Avatar.getAvatarUrl(this, options);
  }
}
